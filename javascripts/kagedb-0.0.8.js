(function (env) {
    ...
    KageDatabase.prototype.transaction = function transaction(storeNames, mode) {
        ...
        function convertMode(mode) {
            ...
            switch (mode) {
                case "r": return defined ? IDBTransaction.READ_ONLY : "readonly";
                case "readonly": return defined ? IDBTransaction.READ_ONLY : "readonly";
                case "rw": return defined ? IDBTransaction.READ_WRITE : "readwrite";
                case "readwrite": return defined ? IDBTransaction.READ_WRITE : "readwrite";
                case "versionchange": return defined ? IDBTransaction.VERSION_CHANGE : "versionchange";
