(function (global) {
    ...
    if (global.msIndexedDB) {
        ...
        (function () {
            ...
            global.IDBDatabase.prototype.createObjectStore = function () {
        ...
        (function () {
            ...
            global.IDBTransaction.prototype.objectStore = function () {
        ...
        (function () {
            ...
            global.IDBObjectStore.prototype.put = function () {
                var methodName = "put";
            ...
            global.IDBObjectStore.prototype.add = function () {
                var methodName = "add";
            ...
            global.IDBObjectStore.prototype["delete"] = function () {
            ...
            global.IDBObjectStore.prototype.get = function () {
                var methodName = "get";
            ...
            global.IDBObjectStore.prototype.clear = function () {
            ...
            global.IDBObjectStore.prototype.openCursor = function () {
            ...
            global.IDBObjectStore.prototype.count = function () {
            ...
            global.IDBObjectStore.prototype.createIndex = function () {
                var index = createIndex_original.apply(this, arguments);
                var kageDB = this.kage_kageDB;
                index.kage_kageDB = kageDB;
                return index;
            };
            global.IDBObjectStore.prototype.index = function () {
        ...
        (function () {
            ...
            global.IDBIndex.prototype.openKeyCursor = function () {
            ...
            global.IDBIndex.prototype.get = function () {
                var methodName = "get";
                var req = get_original.apply(this, arguments);
                var kageDB = this.kage_kageDB;
                kageDB.bindListener("success", req, className, methodName);
            ...
            global.IDBIndex.prototype.getKey = function () {
            ...
            global.IDBIndex.prototype.count = function () {
                var methodName = "count";
                var req = count_original.apply(this, arguments);
                var kageDB = this.kage_kageDB;
                kageDB.bindListener("success", req, className, methodName);
        ...
        (function () {
            ...
            global.IDBCursor.prototype.update = function () {
            ...
            global.IDBCursor.prototype["delete"] = function () {
                var methodName = "delete";
                var req = delete_original.apply(this, arguments);
                var kageDB = this.kage_kageDB;
                kageDB.bindListener("success", req, className, methodName);
        ...
        (function () {
            ...
            global.IDBCursorWithValue.prototype.update = function () {
                var methodName = "update";
                var req = update_original.apply(this, arguments);
                var kageDB = this.kage_kageDB;
                kageDB.bindListener("success", req, className, methodName);
            ...
            global.IDBCursorWithValue.prototype["delete"] = function () {
                var methodName = "delete";
                var req = delete_original.apply(this, arguments);
                var kageDB = this.kage_kageDB;
                kageDB.bindListener("success", req, className, methodName);
