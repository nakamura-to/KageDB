(function (global) {
    ...
    KageDB.prototype.join = function join() {
        ...
        helper.bindListeners(req, this, ["success", "error"]);
    ...
    KageDB.prototype.dump = function dump(dbName, storeNames) {
        ...
        helper.bindListeners(dumpReq, this, ["success", "error"]);
    ...
    (function () {
        ...
        IDBDatabase.prototype.transaction = function () {
            ...
            helper.bindListeners(tx, kageDB, ["abort", "complete", "error"]);
            return tx;
        };
        ...
        if (setVersion_original) {
            IDBDatabase.prototype.setVersion = function () {
                ...
                helper.bindListeners(req, kageDB, ["success", "error"]);
