(function (env) {
    ...
    var helper = {
        ...
        bulk: function bulk(len, execute, success, error) {
            var pending = len;
    ...
    KageDB.prototype._migrate = function _migrate(db, tx, oldVersion, newVersion, complete) {
        var targets = selectTargets(this.migration || {}, oldVersion, newVersion);
    ...
    KageDatabase.prototype.transaction = function transaction(storeNames, mode) {
        ...
        mode = convertMode(mode || this._kageDB.txMode);
    ...
    KageDatabase.prototype.join = function join(requests, success, error) {
        ...
        var req = helper.bulk(requests.length, execute.bind(this), success, error);
        helper.attachInfo(req, this, "join", {});
        return req;

        function execute(i) {
            var req = requests[i];
            helper.attachInfo(req, this, "join", { index: i });
            return req;
        }
    };
    ...
    // alias of `delete`
    KageObjectStore.prototype.remove = KageObjectStore.prototype["delete"];
    ...
    KageObjectStore.prototype.bulkPut = function bulkPut(values, keys, success, error) {
        ...
        var req = helper.bulk(values.length, execute.bind(this), success, error);
    ...
    KageObjectStore.prototype.bulkDelete = function bulkDelete(keys, success, error) {
        ...
        var req = helper.bulk(keys.length, execute.bind(this), success, error);
    ...
    // alias of `bulkDelete`
    KageObjectStore.prototype.bulkRemove = KageObjectStore.prototype.bulkDelete;
    ...
    // alias of `continue`
    KageCursor.prototype.next = KageCursor.prototype["continue"];
    ...
    // alias of `delete`
    KageCursor.prototype.remove = KageCursor.prototype["delete"];
